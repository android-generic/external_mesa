...
mov(8)          g79<2>UD        g35<4,4,1>UD                    { align1 1Q };
mov(8)          g81<2>UD        g36<4,4,1>UD                    { align1 2Q };
add(16)         g39<1>D         -g50<1,1,0>D    g2.1<0,1,0>D    { align1 1H I@3 compacted };
mov(8)          g79.1<2>UD      g39<4,4,1>UD                    { align1 1Q I@1 };
mov(8)          g81.1<2>UD      g40<4,4,1>UD                    { align1 2Q I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        g45UD           g79UD           nullUD          0x08401580                0x00000000
...
mov(8)          g41<2>UD        g73<4,4,1>UD                    { align1 1Q };
...
send(16)        g9UD            g41UD           nullUD          0x08200580                0x00000000
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $1.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.src };
mov(16)         g26<1>D         0D                              { align1 WE_all 1H I@2 };
mov(16)         g26<1>D         g120<8,8,1>D                    { align1 1H };
cmp.z.f0.0(16)  null<1>W        g59<16,16,1>W   0W              { align1 1H I@7 };
add(8)          g26.1<2>D       g26<8,4,2>D     g26.1<8,4,2>D   { align1 WE_all 1Q I@2 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $0.src };
mov(16)         g28<1>UD        g47<16,8,2>UW                   { align1 1H $1.dst };
mov(16)         g30<1>UD        g45<16,8,2>UW                   { align1 1H };
add(16)         g35<1>D         g2<0,1,0>D      24D             { align1 1H compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@5 };
mov(16)         g3<1>UD         g27.7<0,1,0>UD                  { align1 1H };
add(16)         g9<1>D          g28<1,1,0>D     g21<1,1,0>D     { align1 1H I@4 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $1.src };
add(16)         g7<1>D          g30<1,1,0>D     -g21<1,1,0>D    { align1 1H I@4 compacted };
cmp.l.f0.0(16)  g50<1>UD        g35<1,1,0>UD    g2<0,1,0>UD     { align1 1H I@4 compacted };
mov(8)          g79<2>UD        g35<4,4,1>UD                    { align1 1Q $1.src };
mov(8)          g81<2>UD        g36<4,4,1>UD                    { align1 2Q $1.src };
cmp.l.f0.0(16)  g45<1>D         g21<1,1,0>D     g30<1,1,0>D     { align1 1H compacted };
add(16)         g39<1>D         -g50<1,1,0>D    g2.1<0,1,0>D    { align1 1H I@4 compacted };
mov(16)         g5<1>D          -g45<8,8,1>D                    { align1 1H I@2 };
mov(8)          g79.1<2>UD      g39<4,4,1>UD                    { align1 1Q I@2 };
mov(8)          g81.1<2>UD      g40<4,4,1>UD                    { align1 2Q I@3 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
send(16)        nullUD          g79UD           g3UD            0x08003584                0x00000200
...
cmp.l.f0.0(16)  g48<1>UD        g46<1,1,0>UD    g2<0,1,0>UD     { align1 1H I@1 compacted };
mov(8)          g54<2>UD        g46<4,4,1>UD                    { align1 1Q };
mov(8)          g56<2>UD        g47<4,4,1>UD                    { align1 2Q };
add(16)         g37<1>D         -g48<1,1,0>D    g2.1<0,1,0>D    { align1 1H I@3 compacted };
mov(8)          g54.1<2>UD      g37<4,4,1>UD                    { align1 1Q I@1 };
mov(8)          g56.1<2>UD      g38<4,4,1>UD                    { align1 2Q I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
cmp.l.f0.0(16)  g77<1>UD        g75<1,1,0>UD    0x000004acUD    { align1 1H I@3 compacted };
add(16)         g73<1>D         -g71<1,1,0>D    g67<1,1,0>D     { align1 1H I@2 compacted };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $2.src };
add(16)         g41<1>D         -g77<1,1,0>D    g67<1,1,0>D     { align1 1H I@2 compacted };

LABEL7:
cmp.ge.f0.0(16) null<1>UD       g24<8,8,1>UD    0x00000030UD    { align1 1H I@2 };
(+f0.0) break(16) JIP:  LABEL6        UIP:  LABEL6              { align1 1H };
shl(16)         g43<1>D         g24<8,8,1>D     0x00000002UD    { align1 1H $2.src };
mov(16)         g4<1>UD         0x00000000UD                    { align1 1H $1.src };
add(16)         g83<1>D         g75<1,1,0>D     g43<1,1,0>D     { align1 1H I@2 compacted };
...
add(16)         g87<1>D         -g85<1,1,0>D    g41<1,1,0>D     { align1 1H I@3 compacted };
...
add3(16)        g90<1>D         0x0004UW        g43<8,8,1>D     g75<1,1,1>D { align1 1H $8.src };
...
add(16)         g94<1>D         -g92<1,1,0>D    g41<1,1,0>D     { align1 1H I@3 compacted };
...
add3(16)        g97<1>D         0x0008UW        g43<8,8,1>D     g75<1,1,1>D { align1 1H $9.src };
...
add3(16)        g104<1>D        0x000cUW        g43<8,8,1>D     g75<1,1,1>D { align1 1H $10.src };
...
add(16)         g108<1>D        -g106<1,1,0>D   g41<1,1,0>D     { align1 1H I@3 compacted };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $1.src };
cmp.l.f0.0(16)  g79<1>UD        g39<1,1,0>UD    g25<1,1,0>UD    { align1 1H I@1 compacted };
mov(8)          g45<2>UD        g39<4,4,1>UD                    { align1 1Q $13.src };
mov(8)          g47<2>UD        g40<4,4,1>UD                    { align1 2Q $1.dst };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $1.src };
add(16)         g81<1>D         -g79<1,1,0>D    g35<1,1,0>D     { align1 1H I@3 compacted };
mov(8)          g45.1<2>UD      g81<4,4,1>UD                    { align1 1Q I@1 };
mov(8)          g47.1<2>UD      g82<4,4,1>UD                    { align1 2Q I@2 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
mov(8)          g75<2>UD        g69<4,4,1>UD                    { align1 1Q $12.src };
mov(8)          g77<2>UD        g70<4,4,1>UD                    { align1 2Q $12.src };
...
static const uint32_t gfx125_bvh_build_BFS_begin_batchable_code[] = {
    ...
    0xe7321970, 0x02002303, 0x00030061, 0x4f060220,
    0x00342305, 0x00000000, 0x00130061, 0x51060220,
    0x00342405, 0x00000000, 0xa0271b40, 0x02123212,
    0x00031961, 0x4f260220, 0x00342705, 0x00000000,
    0x00131a61, 0x51260220, 0x00342805, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044131, 0x2d240000, 0xfb004f24, 0x00040000,
    ...
    0x00030061, 0x29060220, 0x00344905, 0x00000000,
    0x00130061, 0x2b060220, 0x00344a05, 0x00000000,
    ...
    0x00044231, 0x09140000, 0xfb002924, 0x00000000,
    ...
    0x80003001, 0x00000000, 0x00000000, 0x00000000,
    0x80041a61, 0x1a054660, 0x00000000, 0x00000000,
    0x00040061, 0x1a050660, 0x00467805, 0x00000000,
