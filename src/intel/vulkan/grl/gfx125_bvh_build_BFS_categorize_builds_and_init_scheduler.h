...
fbl(1)          g54<1>UD        g34<0,1,0>UD                    { align1 WE_all 1N I@2 };
shl(1)          a0<1>UD         g54<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@1 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00000400UD    { align1 WE_all 1N A@1 };
mov(1)          g56<1>UD        g[a0 352]<0,1,0>UD              { align1 WE_all 1N A@1 };
cmp.z.f0.0(16)  null<1>D        g58<8,8,1>D     g54<0,1,0>D     { align1 1H I@3 };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $3.src };
shl(1)          a0<1>UD         g56<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@2 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00000400UD    { align1 WE_all 1N A@1 };
mov(1)          g53<1>UD        g[a0 480]<0,1,0>UD              { align1 WE_all 1N A@1 };
(+f0.0) if(16)  JIP:  LABEL15         UIP:  LABEL15             { align1 1H };
mov(16)         g102<1>UD       0x00000000UD                    { align1 1H $2.src };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
mov(16)         g104<1>UD       g53<0,1,0>UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
shl(1)          a0<1>UD         g73<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@1 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00000800UD    { align1 WE_all 1N A@1 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
mov(16)         g107<1>UD       g71<0,1,0>UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
mov(1)          g89<1>UD        g[a0 32]<0,1,0>UD               { align1 WE_all 1N A@1 };
shl(1)          a0<1>UD         g89<0,1,0>UD    0x00000002UD    { align1 WE_all 1N I@1 };
add(1)          a0<1>UD         a0<0,1,0>UD     0x00000a00UD    { align1 WE_all 1N A@1 };
mov(1)          g87<1>UD        g[a0 160]<0,1,0>UD              { align1 WE_all 1N A@1 };
(+f0.0) if(16)  JIP:  LABEL17         UIP:  LABEL17             { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N $2.src };
mov(16)         g108<1>UD       0x00000008UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@3 };
mov(16)         g110<1>UD       g87<0,1,0>UD                    { align1 1H };
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
...
sync nop(1)                     null<0,1,0>UB                   { align1 WE_all 1N I@1 };
cmp.l.f0.0(16)  g54<1>UD        g37<1,1,0>UD    g53<0,1,0>UD    { align1 1H compacted };
...
static const uint32_t gfx125_bvh_build_BFS_categorize_builds_and_init_scheduler_code[] = {
    ...
    0x00002b70, 0x00000898, 0x80002001, 0x00000000,
    ...
    0x00040024, 0x0001c060, 0x000022e8, 0x000022e8,
    ...
    0x00040025, 0x00004600, 0x00000000, 0x00002248,
    ...
    0x80001a4c, 0x36050220, 0x00002204, 0x00000000,
    0x80001969, 0x10018220, 0x02003604, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00000400,
    0x80000961, 0x38050220, 0x00010580, 0x00000000,
    0x00041b70, 0x00010660, 0x16463a05, 0x00003604,
    0x80003301, 0x00000000, 0x00000000, 0x00000000,
    0x80001a69, 0x10018220, 0x02003804, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00000400,
    0x80000961, 0x35050220, 0x00010780, 0x00000000,
    0x01040022, 0x0001c060, 0x00000060, 0x00000060,
    0x00043261, 0x66054220, 0x00000000, 0x00000000,
    0x80001b01, 0x00000000, 0x00000000, 0x00000000,
    0x00040061, 0x68050220, 0x00003504, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044231, 0x6b140000, 0xea186614, 0x01006814,
    0x00040025, 0x00004600, 0x00000000, 0x00001cd8,
    ...
    0x80000961, 0x49050220, 0x00010080, 0x00000000,
    0x80001969, 0x10018220, 0x02004904, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00000800,
    0x80000961, 0x47050220, 0x00010280, 0x00000000,
    0x01040022, 0x0001c060, 0x00000060, 0x00000060,
    0x00043261, 0x69054220, 0x00000000, 0x00000004,
    0x80001b01, 0x00000000, 0x00000000, 0x00000000,
    0x00040061, 0x6b050220, 0x00004704, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044231, 0x6e140000, 0xea186914, 0x01006b14,
    0x00040025, 0x00004600, 0x00000000, 0x00001a18,
    ...
    0x80000961, 0x59050220, 0x00010080, 0x00000000,
    0x80001969, 0x10018220, 0x02005904, 0x00000002,
    0x80000940, 0x10018220, 0x02001000, 0x00000a00,
    0x80000961, 0x57050220, 0x00010280, 0x00000000,
    0x01040022, 0x0001c060, 0x00000070, 0x00000070,
    0x80003201, 0x00000000, 0x00000000, 0x00000000,
    0x00040061, 0x6c054220, 0x00000000, 0x00000008,
    0x80001b01, 0x00000000, 0x00000000, 0x00000000,
    0x00040061, 0x6e050220, 0x00005704, 0x00000000,
    0x80001901, 0x00000000, 0x00000000, 0x00000000,
    0x00044231, 0x71140000, 0xea186c14, 0x01006e14,
    0x00040025, 0x00004600, 0x00000000, 0x00001738,
    ...
    0xa0250040, 0x35113512, 0x80001901, 0x00000000,
    0x00000000, 0x00000000, 0x27360070, 0x35102503,
    0x80002101, 0x00000000, 0x00000000, 0x00000000,
...
const char *gfx125_bvh_build_BFS_categorize_builds_and_init_scheduler_sha1 = "0cd4b7f1367f06f82baabddc940fbab638ec0548";
